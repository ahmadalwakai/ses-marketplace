      ...
      <Container maxW="md">
        <VStack gap={8}>
          <VStack gap={2} textAlign="center">
            ...
            <Text color="gray.600">
              مرحباً بك في سوق سوريا الإلكتروني
            </Text>
          </VStack>
          ...
          >
            <Stack gap={6}>
              ...
              >
                <HStack gap={3}>
                  <GoogleIcon />
                  <Text>{googleLoading ? 'جاري التحميل...' : 'المتابعة مع Google'}</Text>
                </HStack>
              </Button>
                  ...
                  <Stack gap={2}>
                    <HStack justify="space-between">
                      ...
                      <Link href="/auth/forgot-password">
                        <Text color="gray.600" fontSize="sm" _hover={{ color: 'black', textDecoration: 'underline' }}>
                          نسيت كلمة المرور؟
                        </Text>
                      </Link>
                    </HStack>
